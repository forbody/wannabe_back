...
const { delete_todo_list, get_todo_list, modify_todo_list, create_todo_list, share_todo_list, get_todo_list_all } = require('../controllers/todo_list');
...
//[GET] v1/todo_list/
router.get('/', verifyToken ,get_todo_list_all)
